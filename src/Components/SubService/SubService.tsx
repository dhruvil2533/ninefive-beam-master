  ...
  <div className="Dis_container">
    <div className="container">
      ...
      <p>
        ...
        We adhere to LOD specifications across the globe to ensure consistent
        modeling standards.
      </p>
    </div>
  </div>
  ...
  <div className="Dis_container">
    <div className="container">
      ...
      <p>
        ...
        custom families, which are the building blocks of any Revit project.
        Revit families are parametric objects that can be easily modified,
        copied, and reused throughout the project.
      </p>
    </div>
  </div>
);
  ...
  <div className="Dis_container">
    <div className="container">
      ...
      <p>
        ...
        and construction industry, we are dedicated to helping our clients
        create energy-efficient and environmentally friendly buildings through
        innovative BIM solutions. Contact us today to discuss your green energy
        building project requirements. Let us assist you in creating
        energy-efficient, sustainable buildings that make a positive impact on
        the environment and the community. Together, we can build a greener
        future.
      </p>
    </div>
  </div>
  ...
  <div className="Dis_container">
    <div className="container">
      ...
      <p>
        ...
        solutions to esteemed architects, engineers, contractors, and
        construction firms spanning the globe. Our paramount objective is to aid
        you in the metamorphosis of your visionary concepts into impeccably
        intricate and precise drawings, seamlessly optimizing the design and
  ...
  <div className="Dis_container">
    <div className="container">
      ...
      <p>
        ...
        renderings that help bring ideas to life. We emphasize effective
        ...
        schedules, and material lists. Our goal is to facilitate seamless
  ...
  <div className="Dis_container">
    <div className="container">
      ...
      <p>
        ...
        the potential of your space. Whether you need floor plans for
        residential, commercial, or industrial properties, we can cater to your
        specific requirements. By availing our services, you can expect a range
  ...
  <div className="Dis_container">
    <div className="container">
      ...
      <p>
        ...
        designer, real estate developer, or homeowner, our rendering services
  ...
  <div className="Dis_container">
    <div className="container">
      ...
      <p>
        ...
        need captivating visualizations for marketing materials, product
  ...
  <div className="Dis_container">
    <div className="container">
      ...
      <p>
        ...
        processes. Our team can create intricate 3D models of machinery,
