const aboutdes = [
  ...
  },
  {
    ...
    // description:
    //   "Architectural CAD drawings are an essential part of today’s architectural industry. Everyone desires for that perfect design and the start to it is with the 3D Modeling Services models. NineFive specialize in 3D Modeling Services services ranging from PDF to CAD conversion to Red Line Markup drafting.",
    description:
  ...
  },
  {
    ...
    description:
      "Client satisfaction is at the core of our business philosophy. We believe in establishing long-term relationships by delivering exceptional value and exceeding expectations. Our customer-centric approach ensures that we understand your unique needs and provide customized solutions that align with your project goals. Choose NineFive BIM as your trusted outsourcing partner and unlock the full potential of BIM for your AEC projects. Contact us today to discuss how we can collaborate to drive innovation, efficiency, and success in your projects.",
    image: "9.png",
  },
];
